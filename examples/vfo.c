...
int main() {
    ...
    x6200_control_rxvol_set(20);

    x6200_control_vfo_mode_set(X6200_VFO_A, x6200_mode_usb_dig);
    x6200_control_vfo_agc_set(X6200_VFO_A, x6200_agc_fast);
        ...
        if (count > 0) {
            ...
            switch (band) {
                case 0:
                    ...
                    x6200_control_vfo_freq_set(X6200_VFO_A, 7074000);
                    break;

                case 1:
                    printf("--- Freq 10.100 MHz ---\n");
                    x6200_control_vfo_freq_set(X6200_VFO_A, 10100000);
                    break;

                case 2:
                    printf("--- Freq 14.074 MHz ---\n");
                    x6200_control_vfo_freq_set(X6200_VFO_A, 14074000);
                    break;
            }
