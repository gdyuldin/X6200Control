...
if(NOT AETHER_X6200CTRL_DEVELOPER_MODE)
  return()
endif()
...
add_compile_definitions(AETHER_X6200CTRL_DEVELOPER_MODE)
...
foreach(DIAGNOSTIC_FLAG ${DIAGNOSTIC_FLAGS})
  check_c_compiler_flag(${DIAGNOSTIC_FLAG} AETHER_X6200CTRL_HAS_C_${DIAGNOSTIC_FLAG})
  if(AETHER_X6200CTRL_HAS_C_${DIAGNOSTIC_FLAG})
    add_compile_options($<$<COMPILE_LANGUAGE:C>:${DIAGNOSTIC_FLAG}>)
  endif()
  check_cxx_compiler_flag(${DIAGNOSTIC_FLAG} AETHER_X6200CTRL_HAS_CXX_${DIAGNOSTIC_FLAG})
  if(AETHER_X6200CTRL_HAS_CXX_${DIAGNOSTIC_FLAG})
